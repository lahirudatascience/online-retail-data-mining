...
data_path <- "~/Documents/online-retail-data-mining/dataset/online_retail.xlsx"
...
output_path <- "~/Documents/online-retail-data-mining/dataset/online_retail_clean_data.xlsx"
